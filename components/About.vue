<template>
  <section id="about"
    class="bg-gradient-to-br from-slate-50 via-gray-50 to-indigo-50 dark:from-slate-900 dark:via-slate-800 dark:to-indigo-900 py-16 md:py-20 overflow-hidden transition-colors duration-500">
